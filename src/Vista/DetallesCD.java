 ...
 * @author Jazmine
 */
public class DetallesCD extends javax.swing.JFrame {

    /**
     * Creates new form DetallesCD
     */
    public DetallesCD() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblListaRegistrados.setText("Detalles CD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetallesCD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetallesCD().setVisible(true);
            }
        });
    }
