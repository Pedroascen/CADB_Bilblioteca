 ...
 * @author Rocio Abrego
 */
public class ResultadoEjemplares extends javax.swing.JFrame {

    /**
     * Creates new form ResultadoEjemplares
     */
    public ResultadoEjemplares() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadoEjemplares.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultadoEjemplares().setVisible(true);
            }
        });
    }
